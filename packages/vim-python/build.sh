...
MININIX_PKG_DEPENDS="ncurses, vim-runtime, python"
...
# vim-python:
MININIX_PKG_CONFLICTS="vim"
MININIX_PKG_EXTRA_CONFIGURE_ARGS+="
vi_cv_path_python3_pfx=$MININIX_PREFIX
vi_cv_var_python3_version=3.7
--enable-python3interp
--with-python3-config-dir=$MININIX_PREFIX/lib/python3.7/config-3.7m/
"
MININIX_PKG_DESCRIPTION+=" - with python support"
# Remove share/vim/vim81 which is in vim-runtime built as a subpackage of vim:
MININIX_PKG_RM_AFTER_INSTALL+=" share/vim/vim81"
