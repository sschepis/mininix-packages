...
LINUXDROID_PKG_DEPENDS="ncurses, vim-runtime, python"
...
# vim-python:
LINUXDROID_PKG_CONFLICTS="vim"
LINUXDROID_PKG_EXTRA_CONFIGURE_ARGS+="
vi_cv_path_python3_pfx=$LINUXDROID_PREFIX
vi_cv_var_python3_version=3.7
--enable-python3interp
--with-python3-config-dir=$LINUXDROID_PREFIX/lib/python3.7/config-3.7m/
"
LINUXDROID_PKG_DESCRIPTION+=" - with python support"
# Remove share/vim/vim81 which is in vim-runtime built as a subpackage of vim:
LINUXDROID_PKG_RM_AFTER_INSTALL+=" share/vim/vim81"
